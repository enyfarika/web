...
$mail->AddAddress("your_mail@example.com","Your Name ");      //change to your email address
...
$mail->Body     =  $body;
$mail->AltBody  =  "Please switch to HTML view to see content";

if(!$mail->Send()) {
	$recipient = 'your_mail@example.com';    //change to your email address
